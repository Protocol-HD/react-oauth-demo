...
const Main = () => {
    ...
    const appleLoginUrl = `https://appleid.apple.com/auth/authorize?client_id=${appleClientId}&redirect_uri=${appleRedirectUri}&response_type=code%20id_token&state=origin:web`;
